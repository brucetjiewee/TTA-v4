    ...
    <div class="container topSpace">
        <div class="panel-group" id="accordion">
                ...
                <div class="panel-heading bkb">
                    <h1 class="panel-title wHead">
                        <a data-toggle="collapse" data-parent="#accordion" href="#Disclaimer">
                            <img src="Logo.png" alt="TTAv4Logo" style="width: 38px; border: 0; float: center; margin-right: 10px; width:20px" />
                            Disclaimer
                        </a>
                    </h1>
                </div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading bkb">
                    <h1 class="panel-title wHead">
                        <a data-toggle="collapse" data-parent="#accordion" href="#colpnlUsageInstructions"><span aria-hidden="true"  class="glyphicon glyphicon-info-sign"></span> Instructions</a>
                    </h1>
                </div>
                <div id="colpnlUsageInstructions" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ol style="text-align: justify">
                            ...
                            <div class="bkb text-center btn btn-primary" style="display: inline-block" ><span aria-hidden="true" class="glyphicon glyphicon-th bkb"></span> Wizard</div>
                                page using the menu above.</li>
                            <li>Select a campus (or a combination campuses) from the " <span aria-hidden="true" style="" class="glyphicon glyphicon-map-marker"></span> <strong class="bkb">CAMPUS"</strong> section.</li>
                            <li style="color: black">Using the " <span aria-hidden="true" style="" class="glyphicon glyphicon-tags"></span> <strong class="bkb">MODULE"</strong> section, search for modules by typing the module code (or part of it) into the search box, and click
                            <div style="display: inline-block" class="btn btn-primary"><strong>Search <span aria-hidden="true" class="glyphicon glyphicon-search" style="margin-left: 3px"></span> </strong></div>
                                .</li>
                            <li>To add a module to your TimeTable, select it from the resulting list on the left, and click
                            <div style="display: inline-block" class="btn btn-primary"><strong><span aria-hidden="true" class="glyphicon glyphicon-arrow-right"></span> </strong></div>
                                .</li>
                            ...
                            <div style="display: inline-block" class="btn btn-primary"><strong><span aria-hidden="true" class="glyphicon glyphicon-arrow-left"></span> </strong></div>
                                .</li>
                            <li>Using the " <span aria-hidden="true" style="" class="glyphicon glyphicon-time"></span> <strong class="bkb">PERIOD"</strong> section, select the relevant time period (i.e. quarter, semester or year).</li>
                            <li style="color: black">Again using the " <span aria-hidden="true" style="" class="glyphicon glyphicon-time"></span> <strong class="bkb">PERIOD"</strong> section, select the relevant language of instruction (i.e. English or Afrikaans).</li>
                            <li>Once all your desired settings have been provided, click
                            <div style="display: inline-block" class="btn btn-primary"><strong>Generate <span aria-hidden="true" class="glyphicon glyphicon-ok" style="margin-left: 3px"></span> </strong></div>
                                .</li>
                            <li style="color: black">Your generated TimeTable will be presented on a new page.</li>
                            <li>Click
                            <div style="display: inline-block" class="btn btn-primary"><strong>Reset Wizard <span aria-hidden="true" class="glyphicon glyphicon-repeat" style="margin-left: 3px"></span> </strong></div>
                                to return to the wizard and start a new TimeTable.</li>
                            <li>Click
                            <div style="display: inline-block" class="btn btn-primary"><strong>Download <span aria-hidden="true" class="glyphicon glyphicon-download" style="margin-left: 3px"></span> </strong></div>
                                to download the generated TimeTable to the current device.</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="panel panel-primary">
                <div class="panel-heading bkb">
                    <h1 class="panel-title wHead">
                        <a data-toggle="collapse" data-parent="#accordion" href="#colpnlDevelopers"><span aria-hidden="true"  class="glyphicon glyphicon-user"></span> Developers</a>
                    </h1>
                </div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading bkb">
                    <h1 class="panel-title wHead">
                        <a data-toggle="collapse" data-parent="#accordion" href="#colpnlChangelog"><span aria-hidden="true"  class="glyphicon glyphicon-pencil"></span> Changelog</a>
                    </h1>
                </div>
                <div id="colpnlChangelog" class="panel-collapse collapse">
                    <div class="panel-body">
                            ...
                            <div id="colpnlV4Changelog" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <ol style="text-align: left; font-weight: bold">
                                        ...
                                        <li style="color: black">Implemented and adapted the free Agency v3.3.7+1 Bootstrap theme, source available from <a href="https://startbootstrap.com/template-overviews/agency/">StartBootstrap.com</a>.</li>
                                        <%--            <li>Implemented and adapted the free AZMIND Bootstrap Social Icons, source available from <a href="http://azmind.com/bootstrap-social-icons/" style="">Azmind.com</a>.</li>--%>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-primary">
                            ...
                            <div id="colpnlV3Changelog" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <ol style="text-align: left; font-weight: bold">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div id="colpnlV2Changelog" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <ol style="text-align: left; font-weight: bold">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading bkb">
                    <h1 class="panel-title wHead">
                        <a data-toggle="collapse" data-parent="#accordion" href="#colpnlContributors"><span aria-hidden="true"  class="glyphicon glyphicon-thumbs-up"></span> Contributors</a>
                    </h1>
                </div>
                <div id="colpnlContributors" class="panel-collapse collapse">
                    <div class="panel-body">
                        <h1 class="panel-title">Main Concept Contributor: Jeanne-Michael du Plessis</h1>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading bkb">
                    <h1 class="panel-title wHead">
                        <a data-toggle="collapse" data-parent="#accordion" href="#colpnlMotivation"><span aria-hidden="true"  class="glyphicon glyphicon-bullhorn"></span> Motivation</a>
                    </h1>
                </div>
                <div id="colpnlMotivation" class="panel-collapse collapse">
                    <div class="panel-body" style="font-weight: bold; font-size: 120%; text-align: justify; ">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading bkb">
                    <h1 class="panel-title wHead">
                        <a data-toggle="collapse" data-parent="#accordion" href="#colpnlTesters"><span aria-hidden="true"  class="glyphicon glyphicon-cog"></span> Testers</a>
                    </h1>
                </div>
